...
OMC_DISABLE_OPT
int InvertedPendulum_initialAnalyticJacobianLSJac0(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian)
{
  TRACE_PUSH
...
OMC_DISABLE_OPT
int InvertedPendulum_initialAnalyticJacobianLSJac1(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian)
{
  TRACE_PUSH
  DATA* data = ((DATA*)inData);
  const int colPtrIndex[1+1] = {0,1};
...
equation index: 8
type: SIMPLE_ASSIGN
x_acc._$pDERLSJac0._dummyVarLSJac0 = m * l * theta_accel.SeedLSJac0 * $cse1 / (M + m)
*/
void InvertedPendulum_eqFunction_8(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* x_acc.$pDERLSJac0.dummyVarLSJac0 JACOBIAN_DIFF_VAR */ = DIVISION((data->simulationInfo->realParameter[3]) * ((data->simulationInfo->realParameter[2]) * ((jacobian->seedVars[0] /* theta_accel.SeedLSJac0 SEED_VAR */) * (jacobian->tmpVars[0] /* $cse1 JACOBIAN_DIFF_VAR */))),data->simulationInfo->realParameter[0] + data->simulationInfo->realParameter[3],"M + m");
  TRACE_POP
}
...
equation index: 9
type: SIMPLE_ASSIGN
$res1._$pDERLSJac0._dummyVarLSJac0 = l * theta_accel.SeedLSJac0 - x_acc.$pDERLSJac0.dummyVarLSJac0 * $cse1
*/
void InvertedPendulum_eqFunction_9(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERLSJac0.dummyVarLSJac0 JACOBIAN_VAR */ = (data->simulationInfo->realParameter[2]) * (jacobian->seedVars[0] /* theta_accel.SeedLSJac0 SEED_VAR */) - ((jacobian->tmpVars[1] /* x_acc.$pDERLSJac0.dummyVarLSJac0 JACOBIAN_DIFF_VAR */) * (jacobian->tmpVars[0] /* $cse1 JACOBIAN_DIFF_VAR */));
  TRACE_POP
}
int InvertedPendulum_functionJacLSJac0_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH

  DATA* data = ((DATA*)inData);
  int index = InvertedPendulum_INDEX_JAC_LSJac0;
...
equation index: 23
type: SIMPLE_ASSIGN
x_acc._$pDERLSJac1._dummyVarLSJac1 = m * l * theta_accel.SeedLSJac1 * $cse3 / (M + m)
*/
void InvertedPendulum_eqFunction_23(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* x_acc.$pDERLSJac1.dummyVarLSJac1 JACOBIAN_DIFF_VAR */ = DIVISION((data->simulationInfo->realParameter[3]) * ((data->simulationInfo->realParameter[2]) * ((jacobian->seedVars[0] /* theta_accel.SeedLSJac1 SEED_VAR */) * (data->localData[0]->realVars[9] /* $cse3 variable */))),data->simulationInfo->realParameter[0] + data->simulationInfo->realParameter[3],"M + m");
  TRACE_POP
}
...
equation index: 24
type: SIMPLE_ASSIGN
$res1._$pDERLSJac1._dummyVarLSJac1 = l * theta_accel.SeedLSJac1 - x_acc.$pDERLSJac1.dummyVarLSJac1 * $cse3
*/
void InvertedPendulum_eqFunction_24(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERLSJac1.dummyVarLSJac1 JACOBIAN_VAR */ = (data->simulationInfo->realParameter[2]) * (jacobian->seedVars[0] /* theta_accel.SeedLSJac1 SEED_VAR */) - ((jacobian->tmpVars[0] /* x_acc.$pDERLSJac1.dummyVarLSJac1 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[9] /* $cse3 variable */));
  TRACE_POP
}
int InvertedPendulum_functionJacLSJac1_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH

  DATA* data = ((DATA*)inData);
  int index = InvertedPendulum_INDEX_JAC_LSJac1;
