...
extern "C" {
#endif
  #define InvertedPendulum_INDEX_JAC_LSJac28 0
  int InvertedPendulum_functionJacLSJac28_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int InvertedPendulum_initialAnalyticJacobianLSJac28(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
extern "C" {
#endif
  #define InvertedPendulum_INDEX_JAC_LSJac29 1
  int InvertedPendulum_functionJacLSJac29_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int InvertedPendulum_initialAnalyticJacobianLSJac29(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
