...
void InvertedPendulum_initialLinearSystem(int nLinearSystems, LINEAR_SYSTEM_DATA* linearSystemData)
{
  ...
  linearSystemData[1].analyticalJacobianColumn = InvertedPendulum_functionJacLSJac29_column;
  linearSystemData[1].initialAnalyticalJacobian = InvertedPendulum_initialAnalyticJacobianLSJac29;
  ...
  linearSystemData[0].analyticalJacobianColumn = InvertedPendulum_functionJacLSJac28_column;
  linearSystemData[0].initialAnalyticalJacobian = InvertedPendulum_initialAnalyticJacobianLSJac28;
